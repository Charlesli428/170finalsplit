class GameScene extends Phaser.Scene {
  ...
  createHud() {
    this.scoreText = this.add.text(95, 28, 'SCORE 0', {
      fontSize: '22px',
      fill: '#ead6b4',
      fontStyle: 'bold'
    });
    ...
    this.createTimerClock(670, 50, 0x2bbbd8);
  ...
  endGame() {
    ...
    this.time.delayedCall(500, () => {
      this.scene.start('GameOverScene', { score: this.score, name: this.playerName, mode: 'Normal' });
    });
  }
}
